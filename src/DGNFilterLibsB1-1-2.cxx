...
DGNFilterLibsB1_1_2::DGNFilterLibsB1_1_2()
{
...
const std::string& DGNFilterLibsB1_1_2::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int DGNFilterLibsB1_1_2::getInstanceId(const std::string& id) const
{
...
const std::string& DGNFilterLibsB1_1_2::getStatWordDesc(int idx) const
{
