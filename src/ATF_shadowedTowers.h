...
static __inline int ATF__shadowedTowersGet   (const unsigned short *twrsByTile,
                                              int                        tiles,
                                              int                     validCnt);
static __inline int ATF__shadowedTowersByTop (const ATF_shadowedTowersCtl *ctl,
                                              int                        tiles);
static __inline int ATF__shadowedTowersByXM  (const ATF_shadowedTowersCtl *ctl,
                                              int                        tiles);
static __inline int ATF__shadowedTowersByXP  (const ATF_shadowedTowersCtl *ctl,
                                              int                        tiles);
static __inline int ATF__shadowedTowersByYM  (const ATF_shadowedTowersCtl *ctl,
                                              int                        tiles);
static __inline int ATF__shadowedTowersByYP  (const ATF_shadowedTowersCtl *ctl,
                                              int                        tiles);
/* ---------------------------------------------------------------------- */
   ...
   */
   ...
   if (tiles != 0)
   {
       ...
       */
       ...
       while ((tiles = FFS_eliminate (tiles, tile)));
   }
