...
#include "MIPFilterLibsB1-1-0.h"

#include "XFC_DB/MFC_DB_schema.h"
#include "XFC_DB/MIP_DB_instance.h"

MIPFilterLibsB1_1_0::MIPFilterLibsB1_1_0()
{
...
const std::string& MIPFilterLibsB1_1_0::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int MIPFilterLibsB1_1_0::getInstanceId(const std::string& id) const
{
...
const std::string& MIPFilterLibsB1_1_0::getStatWordDesc(int idx) const
{
