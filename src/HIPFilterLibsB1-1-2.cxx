...
HIPFilterLibsB1_1_2::HIPFilterLibsB1_1_2()
{
...
const std::string& HIPFilterLibsB1_1_2::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int HIPFilterLibsB1_1_2::getInstanceId(const std::string& id) const
{
...
const std::string& HIPFilterLibsB1_1_2::getStatWordDesc(int idx) const
{
