...
HIPFilterLibsB1_0_8::HIPFilterLibsB1_0_8()
{
...
const std::string& HIPFilterLibsB1_0_8::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int HIPFilterLibsB1_0_8::getInstanceId(const std::string& id) const
{
...
const std::string& HIPFilterLibsB1_0_8::getStatWordDesc(int idx) const
{
