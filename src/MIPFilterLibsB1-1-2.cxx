...
MIPFilterLibsB1_1_2::MIPFilterLibsB1_1_2()
{
...
const std::string& MIPFilterLibsB1_1_2::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int MIPFilterLibsB1_1_2::getInstanceId(const std::string& id) const
{
...
const std::string& MIPFilterLibsB1_1_2::getStatWordDesc(int idx) const
{
