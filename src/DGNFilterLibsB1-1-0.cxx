...
#include "DGNFilterLibsB1-1-0.h"

#include "XFC_DB/DFC_DB_schema.h"
#include "XFC_DB/DGN_DB_instance.h"

DGNFilterLibsB1_1_0::DGNFilterLibsB1_1_0()
{
...
const std::string& DGNFilterLibsB1_1_0::getInstanceIdString(unsigned short int id) const
{
...
const unsigned short int DGNFilterLibsB1_1_0::getInstanceId(const std::string& id) const
{
